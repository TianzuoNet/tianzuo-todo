  ...
  <q-page padding>
    <q-list
      ...
      <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>使用12小时格式显示时间</q-item-label>
        </q-item-section>
        <q-item-section side>
          <q-toggle
            color="blue"
      ...
      <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>任务在一个列表显示</q-item-label>
        </q-item-section>
        <q-item-section side>
          <q-toggle
            color="blue"
    ...
    <q-list bordered padding>
      <q-item-label header>更多</q-item-label>
      ...
      <q-item
        ...
        v-ripple>
        <q-item-section>
          <q-item-label>访问我们的主页</q-item-label>
        </q-item-section>
        <q-item-section side>
          <q-icon name="chevron_right"/>
        </q-item-section>
      ...
      <q-item
        ...
        v-ripple>
        <q-item-section>
          <q-item-label>给我们发邮件</q-item-label>
        </q-item-section>
        <q-item-section side>
          <q-icon name="chevron_right"/>
        </q-item-section>
...
export default {
  ...
  methods: {
    ...
    emailUs() {
      window.location.href = 'mailto:wu@wuzuoqiang.com?subject=任务管理使用反馈'
    }
  }
}
</script>
